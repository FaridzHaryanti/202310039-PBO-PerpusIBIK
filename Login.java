package pkg202310039.pbo.perpusibik;
...
Login frmLoginPage = new Login(); //initalisasi object pada class Login sebagai bagian dari JFrame
...
labelLogo.setIcon(new ImageIcon("E:/KULIAH/LogoIbik.png"));
...
// Soal No 06 A
    else if(username.equals("202310039") && password.equals("120502")){
